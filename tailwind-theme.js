...
export default {
  ...
  'global': {
    ...
    label: 'block mb-2  text-sm md:text-md font-regular font-sans',
  ...
  'family:box': {
    decorator: 'block relative h-5 w-5 mr-2  bg-gradient-to-b from-transparent to-gray-200 ring-1 ring-gray-400 peer-checked:ring-gray-500 text-transparent peer-checked:text-gray-800 cursor-pointer peer-checked:bg-black',
  ...
  'family:button': {
    input: '$reset inline-flex items-center bg-primaryDark text-white text-sm font-mono py-3 px-6 focus-visible:outline-2 focus-visible:outline-gray-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin',
    wrapper: 'mb-1',
  ...
  'file': {
    ...
    fileRemove: 'relative z-[2] ml-auto text-[0px] hover:text-red-500 pl-2 peer-data-[has-multiple=true]:text-sm peer-data-[has-multiple=true]:text-gray-500 peer-data-[has-multiple=true]:ml-3 peer-data-[has-multiple=true]:mb-2 formkit-multiple:bottom-[0.15em] formkit-multiple:pl-0 formkit-multiple:ml-0 formkit-multiple:left-[1em] formkit-multiple:formkit-prefix-icon:left-[3.75em]',
  ...
  'select': {
    inner: 'flex relative max-w-md items-center rounded mb-1 ring-1 ring-gray-400 focus-within:ring-gray-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-gray-500',
  ...
  'datepicker': {
    ...
    month: `
      ...
      bg-gray-200
      aria-selected:bg-gray-500 aria-selected:text-white
      focus:outline focus:outline-2 focus:outline-gray-500 focus:outline-offset-2 focus:bg-white focus:text-black
    ...
    dayCell: `
      ...
      formkit-disabled:opacity-50 formkit-disabled:cursor-default formkit-disabled:pointer-events-none
    `,
    timeInput: 'w-full border-2 border-gray-300 rounded-md p-2 my-[2em] focus-visible:outline-gray-500',
    ...
    dayButton: 'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-gray-500',
    monthButton: 'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-gray-500',
    yearButton: 'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-gray-500',
  ...
  'repeater': {
    ...
    downControl: 'hover:text-gray-500 disabled:hover:text-inherit disabled:opacity-25',
    fieldset: 'py-4 px-5',
    help: 'mb-2 mt-1.5',
    item: 'flex w-full mb-1 rounded border border-gray-200',
    moveDownIcon: 'block w-3 my-1',
    moveUpIcon: 'block w-3 my-1',
    removeControl: 'hover:text-gray-500 disabled:hover:text-inherit disabled:opacity-25',
    removeIcon: 'block w-5 my-1',
    upControl: 'hover:text-gray-500 disabled:hover:text-inherit disabled:opacity-25',
  },
  'slider': {
    outer: 'max-w-md',
    help: 'mt-0 mb-1',
    ...
    fill: 'h-full rounded-full absolute top-0 mx-[-4px] bg-gray-500',
    ...
    handles: 'm-0 p-0 list-none cursor-pointer',
    handle: 'group w-6 h-6 bg-white absolute top-1/2 left-0 z-[2] -translate-x-1/2 -translate-y-1/2 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.8)] focus-visible:outline-0 focus-visible:none ring-gray-500 data-[is-target="true"]:z-[3]',
  ...
  'toggle': {
    ...
    track: 'p-0.5 min-w-[3em] relative rounded-full transition-all bg-gray-400 peer-checked:bg-gray-500 peer-checked:[&>div:last-child]:left-full peer-checked:[&>div:last-child]:-translate-x-full peer-checked:[&>div:first-child:not(:last-child)]:left-0 peer-checked:[&>div:first-child:not(:last-child)]:translate-x-0',
    valueLabel: 'font-bold text-sm',
    wrapper: 'flex flex-wrap items-center mb-1',
  },
  'transferlist': {
    outer: `
      [&_.dnd-placeholder]:bg-gray-500 [&_.dnd-placeholder]:text-white
    ...
    transferlistListItem: 'pl-8 relative aria-selected:bg-gray-600 aria-selected:data-[is-active=true]:bg-gray-600 aria-selected:text-white aria-selected:data-[is-active=true]:text-white first:-mt-px first:border-t py-2 px-3 flex relative border-b bg-white data-[is-active=true]:text-gray-500 data-[is-active=true]:bg-gray-100 cursor-pointer group-data-[is-max=true]:cursor-not-allowed items-center',
