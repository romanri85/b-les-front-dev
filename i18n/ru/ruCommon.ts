export default {
  ...
  aboutUs: 'О нас',
  classic: 'Классика',
  classicDescription: 'Классика - это коллекция дверей из массива дерева, либо в эмалевом покрытии. Коллекция выполнена в стиле классицизма.',
  versailles: 'Версаль',
  versaillesDescription: 'Версаль - это коллекция дверей в стиле барокко, украшенная остроугольным багетом.',
  premier: 'Премьер',
  premierDescription: 'Премьер - это коллекция дверей в стиле классицизма. Двери этой украшены изящной фрезеровкой.',
  modern: 'Модерн',
  modernDescription: 'Модерн - это коллекция дверей из массива дерева, либо в эмалевом покрытии. Коллекция выполнена в современном стиле.',
  rimini: 'Римини',
  ...
  romani: 'Романи',
  romaniDescription: 'Романи - это коллекция дверей из массива дерева. Коллекция выполнена в стиле классицизма. Двери изготовлены из массива дерева, которое покрыто специальным лаком. Коллекция выполнена в стиле модерн. Двери изготовлены из массива дерева, которое покрыто специальным лаком.',
