...
<!--    </div>-->
    ...
    <div ref="imageDiv" class="relative top-4 w-full flex justify-center pb-8 mb-5 border-b-2 border-transparent transition-all duration-300 ease-in-out">
      <nuxt-img width="160" height="auto" :src="`https://b-les-storage.ams3.digitaloceanspaces.com/media/` + props.hit.merged_image"
                class="h-auto w-48 mdLg:w-40"></nuxt-img>
    </div>

    <div class="flex flex-col items-center pt-5">
      <h3 class="pb-3">{{ props.hit.product_variant.name }}</h3>

      <p class="pb-3 uppercase">{{ props.hit.product_variant.collection }}</p>
