        ...
        >
          ...
          >
            ...
            >
              ...
              <div class="mt-8 mb-8">
                <div v-for="city in props.cities"><h4 class="cursor-pointer mb-4 underline-direction inline-block" @click="changeCity(city.id)">{{city.name}}</h4></div>
...
import CityChoiceAutocomplete from "~/components/pages/where-to-buy/CityChoiceAutocomplete.vue";
